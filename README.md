...
12-28和12-31的大作业现场报告，报过名的组别先开始，未报名组别可能需要到第二次才开始。无论对于那一类组别，报告顺序均由Python程序随机生成。

关于评分：
每个组的报告结束之后，请全体同学，进行一次email打分。请用中大官邮或者授课教师确认过的替代邮箱，发打分email到  lecture_sysu@163.com   。打分信息只需要体现在邮件标题上，标题格式为：组号-分数。

组号和分数均为正数，组号区间为1-82，分数区间为0-100。
